...
*/
std::array<unsigned char, SHA256_DIGEST_LENGTH> crypto::sha256_transaction_without_signature(transaction::serialized_transaction_without_signature* input, int& ret) {
    ret = 0;
